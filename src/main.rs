...
fn main() {
    ...
    let picture_hanger = PictureHanger {
        ...
        height_from_nail_to_top_of_picture: settings.get("height_from_nail_to_top_of_picture").expect("Missing height_from_nail_to_top_of_picture"),
        desired_top_of_picture_height: settings.get("desired_top_of_picture_height").expect("Missing desired_top_of_picture_height"),
        distance_between_frames: settings.get("distance_between_frames").expect("Missing distance_between_frames"),
    };
